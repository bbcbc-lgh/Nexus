...
<style scoped>
.auth-page {
  min-height: 100%; width: 100%; background: var(--bg);
...
.logo-mark {
  width: 82px; height: 52px; background: var(--brand); color: #fff;
...
.err-msg {
  ...
  background: rgba(192,54,77,0.06); border: 1px solid rgba(192,54,77,0.18);
...
.source-badges { display: flex; gap: 8px; position: relative; z-index: 1; flex-wrap: wrap; justify-content: center; }
.badge {
  font-family: 'JetBrains Mono', monospace;
  font-size: 10px; font-weight: 500; padding: 3px 9px; border-radius: 4px; letter-spacing: 0.5px;
}
